...
class LocaleManager {
  ...
  static const LocalizationsDelegate<LocaleManager> delegate =
      _LocaleManagerDelegate();
  ...
  String get findMatch => translate('find_match');
  String get connectInstantly => translate('connect_instantly');
  String get coins => translate('coins');
  String get languageName => translate('language_name');
}

class _LocaleManagerDelegate
    extends LocalizationsDelegate<LocaleManager> {
  const _LocaleManagerDelegate();
  ...
  @override
  bool shouldReload(_LocaleManagerDelegate old) => false;
}
