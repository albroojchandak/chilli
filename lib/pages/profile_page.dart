...
import 'package:chilli/core_services/cloud_storage_service.dart';
import 'package:chilli/helpers/profile_image_helper.dart';
import 'package:chilli/core_services/realtime_db_service.dart'; // ✅ Added Import
...
import 'package:chilli/data_models/user_data.dart'; // ✅ Added Import
...
class _ProfilePageState extends State<ProfilePage>
  ...
  final RealtimeDbService _rtdbService = RealtimeDbService(); // ✅ Added Service
  ...
  Future<void> _loadUserData() async {
    try {
      final coins = await HttpService().getLocalCoins();
  ...
  Future<void> _generateRandomAvatar() async {
    ...
    try {
      ...
      final avatarUrl = ProfileImageHelper.getRandomAvatar(gender);
...
Download now: https://play.google.com/store/apps/details?id=com.chilli.inflyratech
            ...
            children: [
              _buildModernMenuItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const CallsHistoryPage()),
                  );
                },
              ),
              _buildDivider(),
              ...
              _buildModernMenuItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const Terms_Page()),
                  );
                },
              ),
              _buildDivider(),
              _buildModernMenuItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const RefundPolicyContent(),
                    ),
                  );
                },
              ),
              ...
              _buildModernMenuItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const RestrictionPage()),
                  );
                },
              ),
              _buildDivider(),
