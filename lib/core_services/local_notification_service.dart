...
class LocalNotificationService {
  ...
  static Future<void> _handleAnswerCall(Map<String, dynamic> data) async {
    ...
    try {
      ...
      if (uid != null && roomId != null) {
        ...
        print(
          '⚠️ LocalNotificationService: Cannot write to RTDB, UID or RoomID missing',
        );
      }
    } catch (e) {
  ...
  static Future<void> _handleDeclineCall(Map<String, dynamic> data) async {
    ...
    final fcmSender = PushSenderService();
    ...
    final currentUser = FirebaseAuth
        .instance
        .currentUser; // Shouldn't be null if receiving payload
    if (currentUser != null) {
